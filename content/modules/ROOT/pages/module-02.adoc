...
Kubernetes, until 1.21, and OpenShift / OpenShift Virtualization, until 4.21, did not have a native SWAP implementation and thus did now allow use of SWAP.
...
NOTE: We won't configure the *wasp-agent* in this lab due to time and resource constraints but can read the documentation and install process on your own time.

IMPORTANT: Starting with Kubernetes 1.21 and OpenShift 4.21 the *wasp-agent* will be replaced by a native Kubernetes based SWAP implementation.
