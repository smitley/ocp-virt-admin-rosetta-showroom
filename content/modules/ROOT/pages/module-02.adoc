...
+
.. Using the *OpenShift Console*, navigate to *Virtualization → Virtual Machines*. Under *All projects*, select the *over-commit* namespace and select the *overcommit-vm-1* VM to view the *CPU/Memory* allocation.
...
+
Using the *OpenShift Console*, navigate to *Workloads → Pods*. From the *Project:* dropdown and select the *over-commit* namespace to see the *virt-launcher* pod for the VM.
